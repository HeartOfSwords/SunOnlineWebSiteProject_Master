	...
	<nav class="navbar navbar-default navbar-fixed-top navbar-inverse ">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="IndexRouter"> <img src="img/logo_light.png" />
				</a>
			</div>
	...
	<div class="content">
		<div class="article content">
			...
			<div class="article-info">
				<span class="author"> <i class="glyphicon glyphicon-user"></i>文章来源：<%=source %>
				</span>
			</div>
			<!--文章内容-->
			...
			<!--文章信息，上传时间-->
			<div class="article-info">
				<span class="date"> <%=new SimpleDateFormat("yyyy-MM-dd").format(upload_date) %>
				</span>
			</div>
		</div>
	</div>
