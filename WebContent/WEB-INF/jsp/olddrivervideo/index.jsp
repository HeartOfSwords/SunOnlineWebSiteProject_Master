...
<html>
	...
	<body>
		...
		<div class="content">
			...
			<div id="lunbo">
				...
				<div id="myCarousel" class="carousel slide">
					...
					<div class="carousel-inner">
						...
						%>
						<div class="item">
							<img src="<%=oldDriverRecommendationElement.getLSJ_video_pic_url() %>" alt="">
							<div class="carousel-caption">
								<h4></h4>
								<p></p>
							</div>
						...
						<div class="item">
							<img src="http://o7zv69viu.bkt.clouddn.com/old_dirver_pic_01.png" alt="">
							<div class="carousel-caption">
								<h4></h4>
								<p></p>
							</div>
			...
			%>
					<!--内容部分-->
					<a href="OldDriverVideoPlayPage?id=<%=oldDriverVideoBean.getLSJ_video_id()%>">
					<div class="left_item">
						<div class="demo-img">
							<!-- 视频截图url -->
							<img src="<%=oldDriverVideoBean.getLSJ_video_pic_url() %>" />
						</div>
						<div class="demo-content">
						<!-- 视频标题 -->
							<div class="demo-content-title"><%=oldDriverVideoBean.getLSJ_video_name()%></div>
							<!-- 视频简介 -->
							<div class="demo-content-intro">
								<%=oldDriverVideoBean.getLSJ_video_intro() %>
							</div>
							<div class="demo-content-foot">
								<i class="glyphicon glyphicon-user demo-foot-usericon"></i>
								<!-- 上传者 -->
								<span class="demo-foot-username"><%=oldDriverVideoBean.getLSJ_video_uploader() %></span>
								<!-- 播放次数 -->
								<i class="glyphicon glyphicon-play-circle demo-foot-usericon demo-foot-playtime"></i>
								<span class="demo-foot-username"><%=oldDriverVideoBean.getLSJ_video_played_number() %></span>
							</div>
						</div>
					</div>
			</a>
			...
			%>
				...
				%>
					<button type="button" class="btn btn-default" onclick="window.location.href='OldDriverPager?current_pageno=1'"><span class="glyphicon glyphicon-home">首页</span></a></button>
					<button type="button" class="btn btn-default" onclick="window.location.href='OldDriverPager?current_pageno=<%=oldDriverPagerBean.getCurPage() - 1%>'"><span class="glyphicon glyphicon-circle-arrow-left">上一页</span></button>
					<button type="button" class="btn btn-default" onclick="window.location.href='OldDriverPager?current_pageno=<%=oldDriverPagerBean.getCurPage() + 1%>'"><span class="glyphicon glyphicon-circle-arrow-right">下一页</span></button>
					<button type="button" class="btn btn-default" style="margin-right: 10px;" onclick="window.location.href='OldDriverPager?current_pageno=<%=oldDriverPagerBean.getMaxPage()%>'"><span class="glyphicon glyphicon-play">尾页</span></button>
					<span>
							<form action="OldDriverPager" method="post">
		...
		<div id="right">
			<div id="recommend">
				...
				<a href="OldDriverVideoPlayPage?id=<%=oldDriverRecommendationElement.getLSJ_video_id()%>">
					<dl>
						<!-- 视频截图 -->
						<dt><img src="<%=oldDriverRecommendationElement.getLSJ_video_pic_url() %>" width="220px" height="85px" alt="sss"></dt>
						<!-- 视频名称 -->
						<dd><%=oldDriverRecommendationElement.getLSJ_video_name() %></dd>
					</dl>
				</a>		
				<% 		} 
							} else { %>
				<a href="#">
					<dl>
						<dt><img src="img/recomdation_notfound.jpg" width="220px" height="85px" alt="load failed"></dt>
						<dd>推荐视频获取失败请刷新页面</dd>
					</dl>
				</a>	
				<% } %>			
